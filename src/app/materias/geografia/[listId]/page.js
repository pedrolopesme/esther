...
export default function ExerciseListPage() {
  ...
  const { exerciseData, isLoading, error } = useExerciseData('geografia', listId);
    ...
    return (
      <div className="flex flex-col items-center min-h-screen p-6">
        <div className="p-6 rounded-lg bg-red-100 text-red-800 max-w-4xl w-full">
          ...
          <p>{error}</p>
          <Link href="/materias/geografia" className="mt-4 inline-block text-[var(--blue)] hover:underline">
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-6">
      ...
      >
        <Link href="/materias/geografia" className="text-[var(--text-primary)] hover:underline">
          ← Voltar
        </Link>
